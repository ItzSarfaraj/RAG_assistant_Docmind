...
function NotesSidebar({ open, toggleOpen, navigate, noteStructure, setNoteStructure, detailLevel, setDetailLevel, explanationLevel, setExplanationLevel, faithfulToVideo, setFaithfulToVideo, include, toggleInclude, handleRegenerate, regenerating }) {
  ...
  return (
    <aside className={`print-hide relative z-30 flex h-full shrink-0 border-r border-[#E6E1D3] bg-white transition-all duration-200 ${open ? "w-64" : "w-12"}`}>
      {!open ? (
        ...
        <div className="flex h-full min-h-0 w-full flex-col">
          <div className="flex shrink-0 items-center justify-between border-b border-[#E6E1D3] px-4 py-4">
            <div>
          ...
          <div className="shrink-0 border-t border-[#E6E1D3] bg-white p-3">
